import {
    ...
    State,
    Content,
    settings, composeContext, generateObject, ModelClass, HandlerCallback
} from "@elizaos/core";
import { z } from "zod";
...
Extract the following information about the doodle nft
- "Hi! I am doodle 1051 holder!"
- "Please give me doodle 1051 image"
- "I am doodler 1051"
            ...
            actions: [
                {
                    ...
                    handler: async (
                        ...
                        try {
                            ...
                            if (callback) {
                                callback({
                                    text: `Your doodle profile is ${imageUrl}`,
                                    content: {}
                                })
                            }
